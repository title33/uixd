...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        local KeyPicker = {
            ...
            ChangedCallback = Info.Callback or function(New) end;
...
function Library:CreateWindow(...)
    ...
    if typeof(Config.Size) ~= 'UDim2' then Config.Size = UDim2.fromOffset(525, 330) end
